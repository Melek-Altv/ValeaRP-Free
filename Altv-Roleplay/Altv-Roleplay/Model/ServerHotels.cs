...
namespace Altv_Roleplay.Model
{
    class ServerHotels
    {
        ...
        public static void ClearApartmentInventory(int apartmentId)
        {
            try
            {
                ...
                {
                    foreach (var entry in db.Server_Hotels_Storages.ToList().Where(x => x.apartmentId == apartmentId))
                        db.Server_Hotels_Storages.Remove(entry);
                    db.SaveChanges();
                }
            }
            catch (Exception e)
