...
namespace Altv_Roleplay.models
{
    public partial class gtaContext : DbContext
    {
        ...
        public virtual DbSet<Handler.Server_Calls> Server_Calls { get; set; }
        public virtual DbSet<Handler.Attachment_DB> Attachment_DB { get; set; }
        public virtual DbSet<Handler.Server_Crafting_Stations> Server_Crafting_Stations { get; set; }
        public virtual DbSet<Handler.Server_Crafting_Recipes> Server_Crafting_Recipes { get; set; }
        public virtual DbSet<Handler.LifeinvaderAd> LifeinvaderAd { get; set; }
        ...
        public virtual DbSet<Server_nanojobs> server_nanojobs { get; set; }
        ...
        public virtual DbSet<Server_faction_skins> Server_faction_skins { get; set; }
        ...
        public virtual DbSet<Server_Minijob_lkw_Routes> Server_Minijob_lkw_Routes { get; set; }
        public virtual DbSet<Server_Minijob_lkw_Spots> Server_Minijob_lkw_Spots { get; set; }
        public virtual DbSet<Handler.Automat> Automat { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Handler.Server_Calls>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_calls", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.charId).HasColumnName("charId").HasColumnType("int(11)");
                entity.Property(e => e.number).HasColumnName("number").HasColumnType("int(11)");
                entity.Property(e => e.result).HasColumnName("result");
                entity.Property(e => e.timestamp).HasColumnName("timestamp");
            });

            modelBuilder.Entity<Handler.Server_Crafting_Stations>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_crafting_stations", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                ...
                entity.Property(e => e.comment).HasColumnName("comment").HasMaxLength(64);
            });

            modelBuilder.Entity<Handler.Server_Crafting_Recipes>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_crafting_recipes", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.craftingStations).HasColumnName("craftingStations").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<List<int>>(v));
                entity.Property(e => e.neededItems).HasColumnName("neededItems").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<List<Handler.Server_Crafting_Recipes_ItemGroup>>(v));
                entity.Property(e => e.endItem).HasColumnName("endItem").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Handler.Server_Crafting_Recipes_ItemGroup>(v));
                entity.Property(e => e.duration).HasColumnName("duration").HasColumnType("int(11)");
            });

            modelBuilder.Entity<Handler.LifeinvaderAd>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_lifeinvader", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.charId).HasColumnName("charId").HasColumnType("int(11)");
            ...
            modelBuilder.Entity<AccountsCharacters>(entity =>
            {
                ...
                entity.Property(e => e.taxTime).HasColumnName("taxTime");
                ...
                entity.Property(e => e.isStabilisiert).HasColumnName("isStabilisiert");
                ...
                entity.Property(e => e.isPed).HasColumnName("isPed");
                entity.Property(e => e.PedHash).HasColumnName("PedHash");
            });
            ...
            modelBuilder.Entity<Server_Doors>(entity =>
            {
                ...
                entity.Property(e => e.pairs).HasColumnName("pairs").HasMaxLength(64);
            });
            ...
            modelBuilder.Entity<Server_Houses>(entity =>
            {
                ...
                entity.Property(e => e.money).HasColumnName("money");
                entity.Property(e => e.garageSlots).HasColumnName("garageSlots");
                entity.Property(e => e.garagePos).HasColumnName("garagePos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
                entity.Property(e => e.garageVehPos).HasColumnName("garageVehPos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
                entity.Property(e => e.garageVehRot).HasColumnName("garageVehRot").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Rotation>(v));
            });
            ...
            modelBuilder.Entity<Handler.Attachment_DB>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("attachments", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.model).HasColumnName("model");
                entity.Property(e => e.bone).HasColumnName("bone").HasColumnType("int(11)");
                entity.Property(e => e.removeAfterSeconds).HasColumnName("removeAfterSeconds").HasColumnType("int(11)");
                entity.Property(e => e.pos).HasColumnName("pos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Vector3>(v));
                entity.Property(e => e.rot).HasColumnName("rot").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Vector3>(v));
            });
            ...
            modelBuilder.Entity<Server_Shops>(entity =>
            {
                ...
                entity.Property(e => e.robPos).HasColumnName("robPos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
            });
            ...
            modelBuilder.Entity<Server_Vehicles>(entity =>
            {
                ...
                entity.Property(e => e.isInHouseGarage).HasColumnName("isInHouseGarage");
            });
            ...
            modelBuilder.Entity<Server_Minijob_lkw_Routes>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_minijob_lkw_routes", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.routeId).HasColumnName("routeId").HasColumnType("int(11)");
                entity.Property(e => e.routeName).HasColumnName("routeName").HasMaxLength(64);
            ...
            modelBuilder.Entity<Server_Minijob_lkw_Spots>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_minijob_lkw_spots", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.routeId).HasColumnName("routeId").HasColumnType("int(11)");
                entity.Property(e => e.spotId).HasColumnName("spotId").HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Server_faction_skins>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_faction_skins", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.faction).HasColumnName("faction").HasColumnType("int(11)");
                entity.Property(e => e.gender).HasColumnName("gender").HasColumnType("int(11)");
                entity.Property(e => e.clothesName).HasColumnName("clothesName").HasMaxLength(64);
                entity.Property(e => e.rank).HasColumnName("rank").HasColumnType("int(11)");
                entity.Property(e => e.torso).HasColumnName("torso").HasColumnType("int(11)");
                ...
                entity.Property(e => e.glasses).HasColumnName("glasses").HasColumnType("int(11)");
                entity.Property(e => e.glassestex).HasColumnName("glassestex").HasColumnType("int(11)");
                ...
                entity.Property(e => e.shose).HasColumnName("shose").HasColumnType("int(11)");
                entity.Property(e => e.shosetex).HasColumnName("shosetex").HasColumnType("int(11)");
                entity.Property(e => e.decal).HasColumnName("decal").HasColumnType("int(11)");
                entity.Property(e => e.decaltex).HasColumnName("decaltex").HasColumnType("int(11)");
            });

            modelBuilder.Entity<Handler.Automat>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_automaten", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasDatabaseName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.automatenId).HasColumnName("automatenId").HasColumnType("int(11)");
                entity.Property(e => e.posX).HasColumnName("posX");
                entity.Property(e => e.posY).HasColumnName("posY");
                entity.Property(e => e.posZ).HasColumnName("posZ");
            });
