...
namespace Altv_Roleplay.Factories
{
    public class ClassicPlayer : Player
    {
        ...
        public bool isNanonjobUsing { get; set; } = false;
        public bool IsUsingCrafter { get; set; } = false;
        ...
        public Handler.Attachment_Model attachment { get; set; } = null;
        public bool isEinreisedienst { get; set; } = false;
        public bool isSeatbelt { get; set; } = false;
        public string CurrentTestVehicle { get; set; } = "None";
