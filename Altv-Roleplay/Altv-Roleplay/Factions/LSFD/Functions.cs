...
namespace Altv_Roleplay.Factions.LSFD
{
    public class Functions : IScript
    {
        ...
        public static async void RevivePlayer(IPlayer player, IPlayer targetPlayer)
        {
            try
            {
                ...
                if(rnd >= 1 && rnd <= 50)
                {
                    ...
                    Characters.IsCharacterStabilisiert(targetId, false);
        ...
        public static async void HealPlayer(IPlayer player, IPlayer targetPlayer)
        {
            try
            {
                if (player == null || !player.Exists || targetPlayer == null || !targetPlayer.Exists) return;
